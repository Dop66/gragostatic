...
async function carregarRank() {
    ...
    friendCheked.forEach((friend) => {
        temp += 1;
        container.innerHTML += `
                <div class="backdrop-blur-md p-4 md:p-6 border-2 border-[${colorScore(friend.score)}] bg-[#153c3f] w-full flex flex-col md:flex-row items-center justify-between gap-6 md:gap-4">
